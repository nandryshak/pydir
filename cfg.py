...
_EXCLUDES = ["lib", "app.py", "rsc", ".git", "include"] # Exclude matching files or folders from program operation
...
_LOGLEVEL = 1 # Console debug log level. -1 for none, 0 for info, 1 for warning, 2 for errors, 3 for verbose.
